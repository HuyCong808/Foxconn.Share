...
namespace Foxconn.Editor
{
    internal static class IdentityManager
    {
        ...
        public static void DemandOperator() => Demand("Foxconn.Operators");

        public static void DemandProgrammer() => Demand("Foxconn.Programmers");
        ...
        private class UserIdentity : IUserIdentity
        {
            ...
            public bool IsProgrammer => IsInRole("Foxconn.Programmers");

            public bool IsHighProgrammer => IsInRole("Foxconn.Programmers") && !GetIdentityName().Equals("admin");
            ...
            public bool IsOperator => IsInRole("Foxconn.Operators");
