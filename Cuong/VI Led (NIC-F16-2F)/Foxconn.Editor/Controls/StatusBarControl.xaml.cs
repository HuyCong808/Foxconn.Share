...
namespace Foxconn.Editor.Controls
{
    ...
    /// </summary>
    public partial class StatusBarControl : UserControl, IComponentConnector
    {
        public static readonly DependencyProperty StateTextProperty = DependencyProperty.Register(nameof(StateText), typeof(string), typeof(StatusBarControl));
        public static readonly DependencyProperty StateColorProperty = DependencyProperty.Register(nameof(StateColor), typeof(SolidColorBrush), typeof(StatusBarControl));
        public static readonly DependencyProperty ProgressProperty = DependencyProperty.Register(nameof(Progress), typeof(int), typeof(StatusBarControl));
        public static readonly DependencyProperty CircleColorProperty = DependencyProperty.Register(nameof(CircleColor), typeof(SolidColorBrush), typeof(StatusBarControl));
