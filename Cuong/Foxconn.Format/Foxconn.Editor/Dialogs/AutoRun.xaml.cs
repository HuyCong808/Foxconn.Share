...
namespace Foxconn.Editor.Dialogs
{
    ...
    public partial class AutoRun : Window, INotifyPropertyChanged
    {
        ...
        public void UpdateRate(int numPass, int numFail)
        {
            ...
            //p.TotalChecked = p.TotalPass + p.TotalFail;
            //TotalChecked = p.TotalChecked;

            //p.YeildRate = (float)p.TotalPass / p.TotalChecked * 100;
            //YeildRate = (float)Math.Round(p.YeildRate, 2);
