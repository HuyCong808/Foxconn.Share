    ...
    public class CvHSVExtractionQty : NotifyProperty
    {
        ...
        public CvHSVExtractionQty Clone()
        {
            return new CvHSVExtractionQty
            {
                ...
                Value = new ValueRange(Value.Lower, Value.Upper, Value.Minimum, Value.Maximum),
                OKRange = new ValueRange(OKRange.Lower, OKRange.Upper, OKRange.Minimum, OKRange.Maximum),
            };
        }
