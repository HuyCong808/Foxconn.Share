...
namespace Foxconn.App.Controllers.Image
{
    ...
    {
        #region Show to use
        private static void FeatureMatching()
        {
            //int i = 0;
            //long time;
            ...
            //else if (i == 2)
            //{
            //    featureDetectorExtractor = new AKAZE();
            //}
            //else if (i == 3)
            //{
            //    featureDetectorExtractor = new ORB();
            //}
            //else if (i == 4)
            //{
            //    featureDetectorExtractor = new Brisk();
            //}
            //else
            //{
            //    //featureDetectorExtractor = new SURF();
            //}

            //Mat matchResult = DrawMatches.Draw(Step.Image.Mat, mark.Mat, featureDetectorExtractor, out time);
            //if (matchResult != null)
            //{
            //    outputImage = matchResult.ToImage<Bgr, byte>();
            //    CvInvoke.Imwrite("out.jpg", outputImage);
            //}
        ...
        public static Mat Draw(Mat modelImage, Mat observedImage, Feature2D featureDetectorExtractor, out long matchTime)
        {
            ...
            using (VectorOfVectorOfDMatch matches = new VectorOfVectorOfDMatch())
            {
                ...
                if (homography != null)
                {
                    ...
                    System.Console.WriteLine($"Pts length: {pts.Length}");
