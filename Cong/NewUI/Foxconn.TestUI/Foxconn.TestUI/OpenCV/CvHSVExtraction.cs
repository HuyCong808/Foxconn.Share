    ...
    public class CvHSVExtraction : NotifyProperty
    {
        ...
        private bool IsMatched(double s, ValueRange OKrange)
        {
            ...
            else
            {
                if (s >= OKrange.Lower || s < OKrange.Upper)
                {
                    Console.WriteLine("Hue.Lower :" + Hue.Lower);
                    Console.WriteLine("Hue.Upper :" + Hue.Upper);
                    Console.WriteLine("Saturation.Lower :" + Saturation.Lower);
                    Console.WriteLine("Saturation.Upper :" + Saturation.Upper);
                    Console.WriteLine("Value.Lower :" + Value.Lower);
                    Console.WriteLine("Value.Upper :" + Value.Upper);
                    return true;
                }
            }
            return false;
