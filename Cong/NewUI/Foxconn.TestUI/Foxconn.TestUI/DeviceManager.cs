    ...
    internal class DeviceManager
    {
        ...
        public void Open()
        {
            try
            {
                ...
                if (param.Robot1.IsEnabled)
                {
                    ...
                    int nRet = device.Robot.Open(param.Robot1.Host, param.Robot1.Port);
                    if (nRet == 1)
                    {
                ...
                {
                    device.Robot = new SocketClient();
                    int nRet = device.Robot.Open(param.Robot2.Host, param.Robot2.Port);
                    if (nRet == 1)
                    {
                        Trace.WriteLine("DeviceManager.Open: Robot opened");
                    }
        ...
        public int Ping()
        {
            ...
            try
            {
                ...
                if (param.Robot1.IsEnabled)
                {
                    int nRet = device.Robot.Ping(param.Robot1.Host, param.Robot1.Port);
                    if (nRet != 1)
                    {
                ...
                if (param.Robot2.IsEnabled)
                {
                    int nRet = device.Robot.Ping(param.Robot2.Host, param.Robot2.Port);
                    if (nRet != 1)
                    {
                        MessageBox.Show("Robot1 Disconnect");
                        Pret = -1;
